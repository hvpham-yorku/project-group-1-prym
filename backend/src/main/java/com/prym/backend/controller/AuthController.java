...
public class AuthController {
	...
	public ResponseEntity<?> registerBuyer(@RequestBody Map<String, String> request, HttpServletResponse response) {
		// ResponseEntity<?> = The response we send back (can be any type, that's what ?
		// means)
	...
	public ResponseEntity<?> login(@RequestBody Map<String, String> request, HttpServletResponse response) {
		...
		Optional<User> userOptional = authService.login(email, password); // Note that this login is the same for buyer
																			// and seller!
