    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth //defines who can access what urls
                ...
                .requestMatchers(org.springframework.http.HttpMethod.GET, "/api/seller/farm/*").hasRole("BUYER") //(SPECIAL CASE) allow buyers to access a single farm detail page
                .requestMatchers(org.springframework.http.HttpMethod.GET, "/api/seller/*/cow-types").hasRole("BUYER") //(SPECIAL CASE) allow buyers to view a farm's cattle
